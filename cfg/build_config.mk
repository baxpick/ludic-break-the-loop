...
##
OBJS2CLEAN := teopl.dsk teopl.cdt teopl.sna
...
# REMARK: Make sure main file is compiled first so that memory is correctly aligned
CFILES         := $(filter-out $(SRCDIR)/teopl_main.c, $(CFILES))
CFILES         := $(SRCDIR)/teopl_main.c $(CFILES)
